var OPENAI_API_KEY = "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";
...
chatBox.innerHTML = chatBox.innerHTML + "<div class='ma ma_bot'><p class='bot'>안녕하세요 "+localStorage.getItem("username")+"님! 상담용 채팅봇 도움씨에 오신걸 환영해요!</p></div>"
...
var chatBox = document.querySelector(".chatBox");
    chatBox.innerHTML = chatBox.innerHTML + "<div class='ma ma_me'><p class='me'>"+sQuestion+"</p></div>";
...
                console.log("Chat GPT: " + s);
                ...
                chatBox.innerHTML = chatBox.innerHTML + "<div class='ma ma_bot'><p class='bot'>"+s+"</p></div>"
                chatBox.scrollTop = chatBox.scrollHeight;
                TextToSpeech(s);
            }            
        }
